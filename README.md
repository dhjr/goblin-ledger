...
- `about.html` — Information and help page
- `script.js` — Core logic for calculations and UI interactions
- `style.css` — Application styling
- `fonts/` — Game-inspired fonts
- `resource/` — Supplementary assets
...
Created by [dhjr](https://github.com/dhjr)  
